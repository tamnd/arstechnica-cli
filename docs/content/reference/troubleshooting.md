...
Most of these come down to network reality or how arstechnica serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

arstechnica rate-limits like any public site. ars already paces
...
Where a surface is gated, ars reads a cookie or token you supply
...
`ars`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what ars actually did
